...
/*==  P5とP6に対応   ==*/
/*===================*/
Picture* LoadPgmVS_Pic(char *filename,int *type)
{
  /*-- var  --*/
  FILE  *in_fp;
  int i,j,max,tXS,tYS;
  ...
  /*-- Picureのメモリ領域を確保 --*/
  nPic->r  = (unsigned char*)malloc(tXS*tYS*sizeof(unsigned char));
  nPic->g  = (unsigned char*)malloc(tXS*tYS*sizeof(unsigned char));
  nPic->b  = (unsigned char*)malloc(tXS*tYS*sizeof(unsigned char));
  ...
  case 5:
    /*-- cast --*/
    buf = (unsigned char*)malloc(tXS*sizeof(unsigned char));
